...
from app.models import GroupCategory
...
class SaveMessageView(APIView):
    def post(self, request):
        ...
        # Kategoriyani belgilash (agar kerak bo'lsa)
        default_category, _ = GroupCategory.objects.get_or_create(name="Default")

        # Guruhni bazadan olish yoki yaratish
        group, created = Group.objects.get_or_create(
            group_id=group_id,
            defaults={"name": group_name, "category": default_category},
        )
